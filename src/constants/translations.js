...
const T ={
  es:{
    ...
    tabs:{plan:'📍 Plan',vote:'🗳️ Votos',result:'📋 Resultado',more:'💡 Más'},changeHistoryLbl:'Historial de cambios',attendanceLbl:'Asistencia',answerAllToSave:'Responde a todo para guardar',ofLbl:'de',goingLbl:'Van',notGoingLbl:'No van',rangeIncludesOriginal:'Tu rango incluye la hora original — si puedes, selecciona Sí arriba',screenshotBtn:'Descargar como imagen',confirmPlanBtn:'Confirmar este plan',planConfirmed:'¡Plan confirmado!',altDatesLbl:'Fechas alternativas',deadlineLbl:'Fecha límite',deadlinePassed:'Plazo cerrado — no se aceptan más respuestas',goToResults:'Ver resultados',removeDeadline:'Quitar fecha límite',lateArrivals:'Llegan tarde',stopLbl:'Parada',codeLbl:'Código del plan',transportLbl:'Transporte',tBetweenStops:'Transporte entre paradas',tHowToGet:'Cómo llegar',tHowToGetMP:'Cómo llegar desde el punto de encuentro',dateTimeLbl:'Fecha y hora',altDatesEvenYes:'¿Proponer fechas alternativas?',availRangeEvenYes:'¿Indicar tu disponibilidad?',goingToMeetPoint:'Iré al punto de encuentro',goingDirect:'Voy directo al sitio',lateDisabled:'El organizador no permite llegar tarde',mpDisabled:'No hay punto de encuentro',capacityLbl:'Aforo',altDatesDisabled:'El organizador no permite fechas alternativas',availDisabled:'El organizador no permite elegir horas alternativas',availLbl:'Disponibilidad horaria',attendQ:'¿Acudirás?',altDatesHint:'Elige hasta 3 fechas alternativas (opcional)',availHint2:'Rango de horas en el que podrías empezar el plan (opcional)',altDateIsPlan:'Esa fecha ya es la del plan',capMinHint:'Mínimo de personas para confirmar la actividad',capMaxHint:'Máximo de personas que pueden acudir',deadlineHint:'Después de esta fecha el plan quedará confirmado y no podrá cambiarse a no ser que el organizador extienda el plazo.',noDeadlineHint:'El organizador no ha puesto fecha límite. El plan se podrá cambiar hasta la hora de inicio.',datesStep2:'Hora',addressLbl:'Dirección',notesLbl:'Notas',delConfirm2:'¿Eliminar esta parada?',offlineMsg:'Sin conexión — los cambios no se han guardado',onlineMsg:'Conexión restaurada',loadingMap:'Cargando mapa...',mapFailed:'No se pudo cargar el mapa',noMinCap:'Sin aforo mínimo',noMaxCap:'Sin aforo máximo',minCapLbl:'Aforo mínimo',maxCapLbl:'Aforo máximo',minBeforeLbl:'Minutos antes',toleranceLbl:'Tolerancia (máx. retraso)',onTimeQ:'¿Llegas a tiempo?',howLateQ:'¿Cuánto tarde?',maxLateLbl:'Máx. retraso',onTimeLbl:'Puntual',meetYes:'Iré al punto de encuentro',meetNo:'Voy directo al sitio',respSaved:'✓ Guardado — pulsa para actualizar',availStartTime:'¿A qué hora podrías empezar?',availStartHint:'Marca el rango de horas en el que la actividad podría iniciarse para ti. El organizador lo tendrá en consideración.',placeNoMsg:'¿Quieres comentarle algo al organizador?',createOwnPlan:'O crea tu propio plan →',availabilityLbl:'Disponibilidad',noLbl:'No',
    ...
    durationLbl:'Duración',endsAtLbl:'Termina',startTimeLbl:'Hora de inicio',noStartTimeHint:'Añade duración al punto anterior',cancelFirstStopWarn:'El siguiente punto pasará a ser el #1. Mantiene su propia hora de inicio. El punto de encuentro se eliminará.',orgAttendingQ:'¿Vas a ir?',
    requireLoginLbl:'Requerir inicio de sesión',requireLoginHint:'Los invitados deben iniciar sesión para responder',loginRequiredTitle:'Inicio de sesión requerido',loginRequiredMsg:'El organizador requiere que inicies sesión antes de responder.',
    draftRestored:'Borrador restaurado',draftDiscard:'Descartar',autoConfirmTitle:'Auto-confirmación',notYet:'Todavía no',saveLbl:'Guardar',doneLbl:'Hecho',addToCalendar:'Añadir al calendario',addToGCal:'Añadir a Google Calendar',
    ...
    // Landing
    landingHero1:'Conoce gente nueva.',landingHero2:'Queda con quien quieras.',landingSub:'Crea planes espontáneos, descubre quedadas cerca de ti y conoce gente con tus mismos intereses.',landingCta:'Empieza ahora',landingSignIn:'Iniciar sesión',landingStep1:'Crea un plan',landingStep1d:'Elige actividad, lugar, fecha y hora. Así de simple.',landingStep2:'Publica y descubre',landingStep2d:'Tu plan aparece en el feed. Explora los de otros cerca de ti.',landingStep3:'Queda y conoce',landingStep3d:'Habla por chat, queda en persona y haz nuevos amigos.',landingCatTitle:'¿Qué te apetece hacer?',landingTagline:'Planes espontáneos con gente nueva.',landingFree:'Gratis. Sin compromiso. Sin registro de grupo.',
    // Gender
    genderMale:'Hombre',genderFemale:'Mujer',genderNonBinary:'No binario',genderOther:'Otro',genderPreferNot:'Prefiero no decir',
    // PlanCard & Chat
  ...
  en:{
    ...
    comments:'Comments',
    tabs:{plan:'📍 Plan',vote:'🗳️ Votes',result:'📋 Result',more:'💡 More'},changeHistoryLbl:'Change history',attendanceLbl:'Attendance',answerAllToSave:'Answer all to save',ofLbl:'of',goingLbl:'Going',notGoingLbl:'Not going',rangeIncludesOriginal:'Your range includes the original time — if you can make it, select Yes above',screenshotBtn:'Download as image',confirmPlanBtn:'Confirm this plan',planConfirmed:'Plan confirmed!',altDatesLbl:'Alternative dates',deadlineLbl:'Deadline to respond',deadlinePassed:'Deadline passed — responses are closed',goToResults:'See results',removeDeadline:'Remove deadline',lateArrivals:'Late arrivals',stopLbl:'Stop',codeLbl:'Plan code',transportLbl:'Transport',tBetweenStops:'Travel between stops',tHowToGet:'How to get there',tHowToGetMP:'How to get there from the meeting point',dateTimeLbl:'Date & time',altDatesEvenYes:'Suggest alternative dates?',availRangeEvenYes:'Show your availability?',goingToMeetPoint:'Going to meeting point',goingDirect:'Going directly to venue',lateDisabled:'The organizer does not allow late arrivals',mpDisabled:'No meeting point',capacityLbl:'Capacity',altDatesDisabled:'The organizer does not allow alternative dates',availDisabled:'The organizer does not allow alternative times',availLbl:'Time availability',attendQ:'Will you attend?',altDatesHint:'Choose up to 3 alternative dates (optional)',availHint2:'Time range when you could start the plan (optional)',altDateIsPlan:'That date is already the plan date',capMinHint:'Minimum people to confirm the activity',capMaxHint:'Maximum people that can attend',deadlineHint:'After this date the plan will be confirmed and cannot be changed unless the organizer extends the deadline.',noDeadlineHint:'No deadline set. The plan can be changed until the start time.',datesStep2:'Time',addressLbl:'Address',notesLbl:'Notes',delConfirm2:'Delete this stop?',offlineMsg:'No connection — changes not saved',onlineMsg:'Back online',loadingMap:'Loading map...',mapFailed:'Could not load map',noMinCap:'No min capacity',noMaxCap:'No max capacity',minCapLbl:'Min capacity',maxCapLbl:'Max capacity',minBeforeLbl:'Minutes before',toleranceLbl:'Tolerance (max late)',onTimeQ:'Will you be on time?',howLateQ:'How late?',maxLateLbl:'Max late',onTimeLbl:'On time',meetYes:'Meeting point',meetNo:'Going directly',respSaved:'✓ Saved — tap to update',availStartTime:'What time range could you start?',availStartHint:'Select your availability range for starting the activity. The organizer will consider it to propose an alternative time.',placeNoMsg:'Want to tell the organizer something?',createOwnPlan:'Or create your own plan →',availabilityLbl:'Availability',noLbl:'No',
    ...
    durationLbl:'Duration',endsAtLbl:'Ends',startTimeLbl:'Start time',noStartTimeHint:'Set duration on previous stop',cancelFirstStopWarn:'The next stop will become #1. It keeps its own start time. The meeting point will be removed.',orgAttendingQ:'Are you going?',
    requireLoginLbl:'Require login to respond',requireLoginHint:'Invitees must sign in before voting',loginRequiredTitle:'Login required',loginRequiredMsg:'The organizer requires you to sign in before responding.',
    draftRestored:'Draft restored',draftDiscard:'Discard',autoConfirmTitle:'Auto-confirmation',notYet:'Not yet',saveLbl:'Save',doneLbl:'Done',addToCalendar:'Add to calendar',addToGCal:'Add to Google Calendar',
    ...
    landingHero1:'Meet new people.',landingHero2:'Hang out with anyone.',landingSub:'Create spontaneous plans, discover hangouts near you, and meet people who share your interests.',landingCta:'Get started',landingSignIn:'Sign in',landingStep1:'Create a plan',landingStep1d:'Pick an activity, place, date and time. That simple.',landingStep2:'Publish & discover',landingStep2d:'Your plan goes live. Explore others near you.',landingStep3:'Meet up',landingStep3d:'Chat in-app, meet in person, make new friends.',landingCatTitle:'What do you feel like doing?',landingTagline:'Spontaneous plans with new people.',landingFree:'Free. No commitment. No group signup.',
...
tabs:{plan:'📍 Plano',vote:'🗳️ Votos',result:'📋 Resultado',more:'💡 Mais'},changeHistoryLbl:'Histórico de alterações',attendanceLbl:'Presença',screenshotBtn:'Descarregar como imagem',confirmPlanBtn:'Confirmar este plano',planConfirmed:'Plano confirmado!',altDatesLbl:'Datas alternativas',deadlineLbl:'Prazo para responder',deadlinePassed:'Prazo encerrado',removeDeadline:'Remover prazo',lateArrivals:'Chegam tarde',stopLbl:'Paragem',codeLbl:'Código do plano',transportLbl:'Transporte',tBetweenStops:'Transporte entre paragens',tHowToGet:'Como chegar',tHowToGetMP:'Como chegar desde o ponto de encontro',dateTimeLbl:'Data e hora',altDatesEvenYes:'Propor datas alternativas?',availRangeEvenYes:'Indicar disponibilidade?',goingToMeetPoint:'Vou ao ponto de encontro',goingDirect:'Vou direto ao local',lateDisabled:'O organizador não permite atrasos',mpDisabled:'Sem ponto de encontro',capacityLbl:'Lotação',altDatesDisabled:'O organizador não permite datas alternativas',availDisabled:'O organizador não permite horas alternativas',availLbl:'Disponibilidade horária',attendQ:'Vai comparecer?',altDatesHint:'Escolha até 3 datas alternativas (opcional)',availHint2:'Faixa horária em que poderia começar o plano (opcional)',altDateIsPlan:'Essa data já é a do plano',capMinHint:'Mínimo de pessoas para confirmar a atividade',capMaxHint:'Máximo de pessoas que podem comparecer',deadlineHint:'Após esta data o plano ficará confirmado e não poderá ser alterado a menos que o organizador estenda o prazo.',noDeadlineHint:'Sem prazo definido. O plano pode ser alterado até a hora de início.',datesStep2:'Hora',addressLbl:'Morada',notesLbl:'Notas',delConfirm2:'Eliminar esta paragem?',offlineMsg:'Sem conexão — alterações não guardadas',onlineMsg:'Conexão restaurada',loadingMap:'A carregar mapa...',mapFailed:'Não foi possível carregar o mapa',noMinCap:'Sem lotação mín.',noMaxCap:'Sem lotação máx.',onTimeQ:'Chega a tempo?',howLateQ:'Quanto tarde?',maxLateLbl:'Máx. atraso',onTimeLbl:'Pontual',meetYes:'Irei ao ponto de encontro',meetNo:'Vou direto ao local',respSaved:'✓ Guardado — toque para atualizar',availStartTime:'A que horas poderia começar?',
...
durationLbl:'Duração',endsAtLbl:'Termina',startTimeLbl:'Hora de início',noStartTimeHint:'Adicione duração ao ponto anterior',cancelFirstStopWarn:'O próximo ponto passará a ser o #1. Mantém o seu horário de início. O ponto de encontro será removido.',orgAttendingQ:'Vai participar?',
requireLoginLbl:'Requer início de sessão',requireLoginHint:'Os convidados devem iniciar sessão para responder',loginRequiredTitle:'Início de sessão necessário',loginRequiredMsg:'O organizador requer que inicie sessão antes de responder.',
draftRestored:'Rascunho restaurado',draftDiscard:'Descartar',autoConfirmTitle:'Confirmação automática',notYet:'Ainda não',saveLbl:'Guardar',doneLbl:'Feito',addToCalendar:'Adicionar ao calendário',addToGCal:'Adicionar ao Google Calendar',
...
noDataYet:'Sem dados ainda',noDataHint:'Quando responderem, verá os dados aqui',maxDatesMsg:(n)=>`Máximo ${n} datas`,
    landingHero1:'Conhece gente nova.',landingHero2:'Combina com quem quiseres.',landingSub:'Cria planos espontâneos, descobre encontros perto de ti e conhece pessoas com os teus interesses.',landingCta:'Começa agora',landingSignIn:'Iniciar sessão',landingStep1:'Cria um plano',landingStep1d:'Escolhe atividade, local, data e hora. Simples.',landingStep2:'Publica e descobre',landingStep2d:'O teu plano aparece no feed. Explora outros perto de ti.',landingStep3:'Encontra e conhece',landingStep3d:'Fala no chat, encontra pessoalmente e faz novos amigos.',landingCatTitle:'O que te apetece fazer?',landingTagline:'Planos espontâneos com gente nova.',landingFree:'Grátis. Sem compromisso.',
...
tabs:{plan:'📍 Plan',vote:'🗳️ Votes',result:'📋 Résultat',more:'💡 Plus'},changeHistoryLbl:'Historique',attendanceLbl:'Présence',screenshotBtn:'Télécharger en image',confirmPlanBtn:'Confirmer ce plan',planConfirmed:'Plan confirmé !',altDatesLbl:'Dates alternatives',deadlineLbl:'Date limite',deadlinePassed:'Délai dépassé',removeDeadline:'Supprimer la date limite',lateArrivals:'En retard',stopLbl:'Arrêt',codeLbl:'Code du plan',transportLbl:'Transport',tBetweenStops:'Transport entre arrêts',tHowToGet:'Comment y aller',tHowToGetMP:'Comment y aller depuis le point de rencontre',dateTimeLbl:'Date et heure',altDatesEvenYes:'Proposer des dates alternatives ?',availRangeEvenYes:'Indiquer votre disponibilité ?',goingToMeetPoint:'J\'irai au point de rencontre',goingDirect:'Je vais directement sur place',lateDisabled:'L\'organisateur n\'autorise pas les retards',mpDisabled:'Pas de point de rencontre',capacityLbl:'Capacité',altDatesDisabled:'L\'organisateur n\'autorise pas les dates alternatives',availDisabled:'L\'organisateur n\'autorise pas les horaires alternatifs',availLbl:'Disponibilité horaire',attendQ:'Serez-vous présent ?',altDatesHint:'Choisissez jusqu\'à 3 dates alternatives (optionnel)',availHint2:'Plage horaire où vous pourriez commencer le plan (optionnel)',altDateIsPlan:'Cette date est déjà celle du plan',capMinHint:'Minimum de personnes pour confirmer l\'activité',capMaxHint:'Maximum de personnes pouvant participer',deadlineHint:'Après cette date le plan sera confirmé et ne pourra être modifié sauf si l\'organisateur prolonge le délai.',noDeadlineHint:'Pas de date limite. Le plan peut être modifié jusqu\'à l\'heure de début.',datesStep2:'Heure',addressLbl:'Adresse',notesLbl:'Notes',delConfirm2:'Supprimer cet arrêt ?',offlineMsg:'Pas de connexion — modifications non enregistrées',onlineMsg:'Connexion rétablie',loadingMap:'Chargement de la carte...',mapFailed:'Impossible de charger la carte',noMinCap:'Pas de capacité min.',noMaxCap:'Pas de capacité max.',onTimeQ:'Arrivez-vous à l\'heure ?',howLateQ:'Combien de retard ?',maxLateLbl:'Retard max.',onTimeLbl:"À l'heure",meetYes:'Point de rencontre',meetNo:'Je vais directement',respSaved:'✓ Enregistré — appuyez pour modifier',availStartTime:'À quelle heure pourriez-vous commencer ?',signOut:'Déconnexion',todayLbl:"Aujourd'hui !",tomorrowLbl:'Demain !',
...
durationLbl:'Durée',endsAtLbl:'Fin',startTimeLbl:'Heure de début',noStartTimeHint:'Ajoutez une durée au point précédent',cancelFirstStopWarn:'Le prochain point deviendra le #1. Il garde son heure de début. Le point de rencontre sera supprimé.',orgAttendingQ:'Vous y allez ?',
requireLoginLbl:'Connexion requise pour répondre',requireLoginHint:'Les invités doivent se connecter pour voter',loginRequiredTitle:'Connexion requise',loginRequiredMsg:"L'organisateur exige que vous vous connectiez avant de répondre.",
draftRestored:'Brouillon restauré',draftDiscard:'Supprimer',autoConfirmTitle:'Confirmation automatique',notYet:'Pas encore',saveLbl:'Enregistrer',doneLbl:'Terminé',addToCalendar:'Ajouter au calendrier',addToGCal:'Ajouter à Google Calendar',createError:'Erreur lors de la création. Vérifiez votre connexion.',
...
editNameLbl:'Nom',editDescLbl:'Description',editDatesLbl:'Dates',editTimesLbl:'Horaires',noDataYet:'Pas encore de données',noDataHint:'Quand les invités répondront, vous verrez les données ici',maxDatesMsg:(n)=>`Maximum ${n} dates`,
    ...
    landingHero1:'Rencontre du monde.',landingHero2:'Sors avec qui tu veux.',landingSub:'Crée des plans spontanés, découvre des sorties près de chez toi et rencontre des gens qui partagent tes intérêts.',landingCta:'Commencer',landingSignIn:'Se connecter',landingStep1:'Crée un plan',landingStep1d:'Choisis activité, lieu, date et heure. Aussi simple que ça.',landingStep2:'Publie et découvre',landingStep2d:'Ton plan apparaît dans le feed. Explore ceux des autres.',landingStep3:'Retrouve-toi',landingStep3d:'Discute dans le chat, retrouve-toi en personne.',landingCatTitle:'Qu\'est-ce qui te tente ?',landingTagline:'Plans spontanés avec de nouvelles personnes.',landingFree:'Gratuit. Sans engagement.',
...
tabs:{plan:'📍 Plan',vote:'🗳️ Stimmen',result:'📋 Ergebnis',more:'💡 Mehr'},changeHistoryLbl:'Änderungsverlauf',attendanceLbl:'Teilnahme',screenshotBtn:'Als Bild herunterladen',confirmPlanBtn:'Plan bestätigen',planConfirmed:'Plan bestätigt!',altDatesLbl:'Alternative Termine',deadlineLbl:'Antwortfrist',deadlinePassed:'Frist abgelaufen',removeDeadline:'Frist entfernen',lateArrivals:'Kommen zu spät',stopLbl:'Halt',codeLbl:'Plan-Code',transportLbl:'Transport',tBetweenStops:'Transport zwischen Stopps',tHowToGet:'So kommst du hin',tHowToGetMP:'So kommst du vom Treffpunkt hin',dateTimeLbl:'Datum & Uhrzeit',altDatesEvenYes:'Alternative Termine vorschlagen?',availRangeEvenYes:'Verfügbarkeit angeben?',goingToMeetPoint:'Gehe zum Treffpunkt',goingDirect:'Gehe direkt zum Veranstaltungsort',lateDisabled:'Der Organisator erlaubt keine Verspätungen',mpDisabled:'Kein Treffpunkt',capacityLbl:'Kapazität',altDatesDisabled:'Der Organisator erlaubt keine alternativen Termine',availDisabled:'Der Organisator erlaubt keine alternativen Zeiten',availLbl:'Zeitverfügbarkeit',attendQ:'Wirst du teilnehmen?',altDatesHint:'Wähle bis zu 3 alternative Termine (optional)',availHint2:'Zeitspanne, in der du den Plan starten könntest (optional)',altDateIsPlan:'Dieses Datum ist bereits das Plandatum',capMinHint:'Mindestanzahl Personen zur Bestätigung',capMaxHint:'Maximale Teilnehmerzahl',deadlineHint:'Nach diesem Datum wird der Plan bestätigt und kann nicht mehr geändert werden, es sei denn, der Organisator verlängert die Frist.',noDeadlineHint:'Keine Frist gesetzt. Der Plan kann bis zur Startzeit geändert werden.',datesStep2:'Uhrzeit',addressLbl:'Adresse',notesLbl:'Notizen',delConfirm2:'Diesen Halt löschen?',offlineMsg:'Keine Verbindung — Änderungen nicht gespeichert',onlineMsg:'Wieder online',loadingMap:'Karte wird geladen...',mapFailed:'Karte konnte nicht geladen werden',noMinCap:'Keine Min.-Kapazität',noMaxCap:'Keine Max.-Kapazität',onTimeQ:'Kommst du pünktlich?',howLateQ:'Wie spät?',maxLateLbl:'Max. Verspätung',onTimeLbl:'Pünktlich',meetYes:'Treffpunkt',meetNo:'Gehe direkt hin',respSaved:'✓ Gespeichert — tippen zum Aktualisieren',availStartTime:'Um wie viel Uhr könntest du anfangen?',signOut:'Abmelden',todayLbl:'Heute!',tomorrowLbl:'Morgen!',
...
durationLbl:'Dauer',endsAtLbl:'Ende',startTimeLbl:'Startzeit',noStartTimeHint:'Dauer beim vorherigen Punkt einstellen',cancelFirstStopWarn:'Der nächste Punkt wird #1. Er behält seine Startzeit. Der Treffpunkt wird entfernt.',orgAttendingQ:'Gehst du hin?',
requireLoginLbl:'Anmeldung erforderlich',requireLoginHint:'Eingeladene müssen sich anmelden, um abzustimmen',loginRequiredTitle:'Anmeldung erforderlich',loginRequiredMsg:'Der Organisator verlangt, dass du dich anmeldest, bevor du antworten kannst.',
draftRestored:'Entwurf wiederhergestellt',draftDiscard:'Verwerfen',autoConfirmTitle:'Automatische Bestätigung',notYet:'Noch nicht',saveLbl:'Speichern',doneLbl:'Fertig',addToCalendar:'Zum Kalender hinzufügen',addToGCal:'Zu Google Calendar hinzufügen',createError:'Fehler beim Erstellen. Überprüfe deine Verbindung.',
...
editNameLbl:'Name',editDescLbl:'Beschreibung',editDatesLbl:'Termine',editTimesLbl:'Zeiten',noDataYet:'Noch keine Daten',noDataHint:'Wenn Eingeladene antworten, siehst du die Daten hier',maxDatesMsg:(n)=>`Maximal ${n} Termine`,
    ...
    landingHero1:'Lerne neue Leute kennen.',landingHero2:'Triff dich mit wem du willst.',landingSub:'Erstelle spontane Pläne, entdecke Treffen in deiner Nähe und lerne Leute mit gleichen Interessen kennen.',landingCta:'Jetzt starten',landingSignIn:'Anmelden',landingStep1:'Erstelle einen Plan',landingStep1d:'Wähle Aktivität, Ort, Datum und Uhrzeit.',landingStep2:'Veröffentliche & entdecke',landingStep2d:'Dein Plan wird sichtbar. Entdecke andere in deiner Nähe.',landingStep3:'Triff dich',landingStep3d:'Chatte in der App, triff dich persönlich.',landingCatTitle:'Worauf hast du Lust?',landingTagline:'Spontane Pläne mit neuen Leuten.',landingFree:'Kostenlos. Unverbindlich.',
...
tabs:{plan:'📍 Piano',vote:'🗳️ Voti',result:'📋 Risultato',more:'💡 Altro'},changeHistoryLbl:'Cronologia modifiche',attendanceLbl:'Partecipazione',screenshotBtn:'Scarica come immagine',confirmPlanBtn:'Conferma piano',planConfirmed:'Piano confermato!',altDatesLbl:'Date alternative',deadlineLbl:'Scadenza',deadlinePassed:'Scadenza superata',removeDeadline:'Rimuovi scadenza',lateArrivals:'In ritardo',stopLbl:'Tappa',codeLbl:'Codice piano',transportLbl:'Trasporto',tBetweenStops:'Trasporto tra tappe',tHowToGet:'Come arrivare',tHowToGetMP:'Come arrivare dal punto di incontro',dateTimeLbl:'Data e ora',altDatesEvenYes:'Proporre date alternative?',availRangeEvenYes:'Indicare disponibilità?',goingToMeetPoint:'Andrò al punto di incontro',goingDirect:'Vado direttamente al locale',lateDisabled:'L\'organizzatore non consente ritardi',mpDisabled:'Nessun punto di incontro',capacityLbl:'Capienza',altDatesDisabled:'L\'organizzatore non consente date alternative',availDisabled:'L\'organizzatore non consente orari alternativi',availLbl:'Disponibilità oraria',attendQ:'Parteciperai?',altDatesHint:'Scegli fino a 3 date alternative (opzionale)',availHint2:'Fascia oraria in cui potresti iniziare il piano (opzionale)',altDateIsPlan:'Quella data è già quella del piano',capMinHint:'Minimo di persone per confermare l\'attività',capMaxHint:'Massimo di persone che possono partecipare',deadlineHint:'Dopo questa data il piano sarà confermato e non potrà essere modificato a meno che l\'organizzatore non prolunghi la scadenza.',noDeadlineHint:'Nessuna scadenza impostata. Il piano può essere modificato fino all\'ora di inizio.',datesStep2:'Ora',addressLbl:'Indirizzo',notesLbl:'Note',delConfirm2:'Eliminare questa tappa?',offlineMsg:'Nessuna connessione — modifiche non salvate',onlineMsg:'Di nuovo online',loadingMap:'Caricamento mappa...',mapFailed:'Impossibile caricare la mappa',noMinCap:'Nessuna capienza min.',noMaxCap:'Nessuna capienza max.',onTimeQ:'Arrivi in orario?',howLateQ:'Quanto tardi?',maxLateLbl:'Ritardo max.',onTimeLbl:'In orario',meetYes:'Punto di incontro',meetNo:'Vado direttamente',respSaved:'✓ Salvato — tocca per aggiornare',availStartTime:'A che ora potresti iniziare?',signOut:'Esci',todayLbl:'Oggi!',tomorrowLbl:'Domani!',
...
durationLbl:'Durata',endsAtLbl:'Fine',startTimeLbl:'Ora di inizio',noStartTimeHint:'Aggiungi durata al punto precedente',cancelFirstStopWarn:'Il prossimo punto diventerà il #1. Mantiene il suo orario di inizio. Il punto d\'incontro verrà rimosso.',orgAttendingQ:'Ci vai?',
requireLoginLbl:'Accesso richiesto per rispondere',requireLoginHint:'Gli invitati devono accedere per votare',loginRequiredTitle:'Accesso richiesto',loginRequiredMsg:"L'organizzatore richiede l'accesso prima di rispondere.",
draftRestored:'Bozza ripristinata',draftDiscard:'Elimina',autoConfirmTitle:'Conferma automatica',notYet:'Non ancora',saveLbl:'Salva',doneLbl:'Fatto',addToCalendar:'Aggiungi al calendario',addToGCal:'Aggiungi a Google Calendar',createError:'Errore nella creazione. Controlla la tua connessione.',
...
editNameLbl:'Nome',editDescLbl:'Descrizione',editDatesLbl:'Date',editTimesLbl:'Orari',noDataYet:'Nessun dato ancora',noDataHint:'Quando gli invitati risponderanno, vedrai i dati qui',maxDatesMsg:(n)=>`Massimo ${n} date`,
    ...
    landingHero1:'Conosci gente nuova.',landingHero2:'Esci con chi vuoi.',landingSub:'Crea piani spontanei, scopri eventi vicino a te e conosci persone con i tuoi stessi interessi.',landingCta:'Inizia ora',landingSignIn:'Accedi',landingStep1:'Crea un piano',landingStep1d:'Scegli attività, luogo, data e ora. Semplice.',landingStep2:'Pubblica e scopri',landingStep2d:'Il tuo piano appare nel feed. Esplora quelli degli altri.',landingStep3:'Incontra',landingStep3d:'Chatta nell\'app, incontra di persona.',landingCatTitle:'Cosa ti va di fare?',landingTagline:'Piani spontanei con gente nuova.',landingFree:'Gratis. Senza impegno.',
