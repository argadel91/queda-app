...
const T ={
  es:{
    ...
    tabs:{plan:'📍 Plan',vote:'🗳️ Votos',summary:'📊 Resumen',more:'💡 Más'},voteWhen:'¿Cuándo?',voteWhere:'¿Dónde?',stopLbl:'Parada',codeLbl:'Código del plan',transportLbl:'Transporte',addressLbl:'Dirección',notesLbl:'Notas',delConfirm2:'¿Eliminar esta parada?',
  ...
  en:{
    ...
    comments:'Comments',
    tabs:{plan:'📍 Plan',vote:'🗳️ Votes',summary:'📊 Summary',more:'💡 More'},voteWhen:'When?',voteWhere:'Where?',stopLbl:'Stop',codeLbl:'Plan code',transportLbl:'Transport',addressLbl:'Address',notesLbl:'Notes',delConfirm2:'Delete this stop?',
...
tabs:{plan:'📍 Plano',vote:'🗳️ Votos',summary:'📊 Resumo',more:'💡 Mais'},voteWhen:'Quando?',voteWhere:'Onde?',stopLbl:'Paragem',codeLbl:'Código do plano',transportLbl:'Transporte',addressLbl:'Morada',notesLbl:'Notas',delConfirm2:'Eliminar esta paragem?',alternativeDates:'Datas alternativas',
...
tabs:{plan:'📍 Piano',vote:'🗳️ Voti',summary:'📊 Riepilogo',more:'💡 Altro'},voteWhen:'Quando?',voteWhere:'Dove?',stopLbl:'Tappa',codeLbl:'Codice piano',transportLbl:'Trasporto',addressLbl:'Indirizzo',notesLbl:'Note',delConfirm2:'Eliminare questa tappa?',alternativeDates:'Date alternative',discoverT:'Scopri',discoverS:'Piani pubblici aperti a tutti.',noPublic:'Nessun piano pubblico al momento.',joinPlan:'Unisciti →',yourRoleLbl:'Il tuo ruolo',optionalLbl:'facoltativo',otherRolePh:'Oppure scrivi il tuo...',surpriseMode_lbl:'🎭 Modalità sorpresa',surpriseReveal:'È una sorpresa!',surpriseSub:"La destinazione viene rivelata quando la data è confermata.",signOut:'Esci',todayLbl:'Oggi!',tomorrowLbl:'Domani!',
