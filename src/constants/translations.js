...
tabs:{plan:'📍 Plano',vote:'🗳️ Votos',more:'💡 Mais'},deadlineLbl:'Prazo para responder',deadlinePassed:'Prazo encerrado',remainingLbl:'restante',removeDeadline:'Remover prazo',lateArrivals:'Chegam tarde',voteWhen:'Quando?',voteWhere:'Onde?',stopLbl:'Paragem',codeLbl:'Código do plano',transportLbl:'Transporte',addressLbl:'Morada',notesLbl:'Notas',delConfirm2:'Eliminar esta paragem?',noMinCap:'Sem lotação mín.',noMaxCap:'Sem lotação máx.',onTimeQ:'Chega a tempo?',howLateQ:'Quanto tarde?',maxLateLbl:'Máx. atraso',onTimeLbl:'Pontual',meetYes:'Lá estarei!',meetNo:'Vou direto ao local',respSaved:'✓ Guardado — toque para atualizar',availStartTime:'A que horas poderia começar?',alternativeDates:'Datas alternativas',
