...
const T ={
  es:{
    ...
    durationLbl:'Duración',endsAtLbl:'Termina',startTimeLbl:'Hora de inicio',noStartTimeHint:'Añade duración al punto anterior',cancelFirstStopWarn:'El siguiente punto pasará a ser el #1. Mantiene su propia hora de inicio. El punto de encuentro se eliminará.',
  ...
  en:{
    ...
    durationLbl:'Duration',endsAtLbl:'Ends',startTimeLbl:'Start time',noStartTimeHint:'Set duration on previous stop',cancelFirstStopWarn:'The next stop will become #1. It keeps its own start time. The meeting point will be removed.',
...
durationLbl:'Duração',endsAtLbl:'Termina',startTimeLbl:'Hora de início',noStartTimeHint:'Adicione duração ao ponto anterior',cancelFirstStopWarn:'O próximo ponto passará a ser o #1. Mantém o seu horário de início. O ponto de encontro será removido.',
...
durationLbl:'Durée',endsAtLbl:'Fin',startTimeLbl:'Heure de début',noStartTimeHint:'Ajoutez une durée au point précédent',cancelFirstStopWarn:'Le prochain point deviendra le #1. Il garde son heure de début. Le point de rencontre sera supprimé.',
...
durationLbl:'Dauer',endsAtLbl:'Ende',startTimeLbl:'Startzeit',noStartTimeHint:'Dauer beim vorherigen Punkt einstellen',cancelFirstStopWarn:'Der nächste Punkt wird #1. Er behält seine Startzeit. Der Treffpunkt wird entfernt.',
...
durationLbl:'Durata',endsAtLbl:'Fine',startTimeLbl:'Ora di inizio',noStartTimeHint:'Aggiungi durata al punto precedente',cancelFirstStopWarn:'Il prossimo punto diventerà il #1. Mantiene il suo orario di inizio. Il punto d\'incontro verrà rimosso.',
