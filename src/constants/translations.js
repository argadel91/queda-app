...
tabs:{plan:'📍 Plan',vote:'🗳️ Stimmen',result:'📋 Ergebnis',more:'💡 Mehr'},changeHistoryLbl:'Änderungsverlauf',attendanceLbl:'Teilnahme',screenshotBtn:'Als Bild herunterladen',confirmPlanBtn:'Plan bestätigen',planConfirmed:'Plan bestätigt!',altDatesLbl:'Alternative Termine',deadlineLbl:'Antwortfrist',deadlinePassed:'Frist abgelaufen',removeDeadline:'Frist entfernen',lateArrivals:'Kommen zu spät',stopLbl:'Halt',codeLbl:'Plan-Code',transportLbl:'Transport',tBetweenStops:'Transport zwischen Stopps',tHowToGet:'So kommst du hin',dateTimeLbl:'Datum & Uhrzeit',altDatesEvenYes:'Alternative Termine vorschlagen?',availRangeEvenYes:'Verfügbarkeit angeben?',goingToMeetPoint:'Gehe zum Treffpunkt',goingDirect:'Gehe direkt zum Veranstaltungsort',lateDisabled:'Der Organisator erlaubt keine Verspätungen',mpDisabled:'Kein Treffpunkt',addressLbl:'Adresse',notesLbl:'Notizen',delConfirm2:'Diesen Halt löschen?',offlineMsg:'Keine Verbindung — Änderungen nicht gespeichert',onlineMsg:'Wieder online',loadingMap:'Karte wird geladen...',mapFailed:'Karte konnte nicht geladen werden',noMinCap:'Keine Min.-Kapazität',noMaxCap:'Keine Max.-Kapazität',onTimeQ:'Kommst du pünktlich?',howLateQ:'Wie spät?',maxLateLbl:'Max. Verspätung',onTimeLbl:'Pünktlich',meetYes:'Treffpunkt',meetNo:'Gehe direkt hin',respSaved:'✓ Gespeichert — tippen zum Aktualisieren',availStartTime:'Um wie viel Uhr könntest du anfangen?',signOut:'Abmelden',todayLbl:'Heute!',tomorrowLbl:'Morgen!',
