...
landingSignIn:'Accedi',landingHero1:'Più piani,',landingHero2:'meno caos.',landingSub2:'Dì addio alle chat infinite.',landingCTA2:'Inizia',landingFooter:'Piani di gruppo, zero caos.',whenTitle:'Quando?',whereTitle:'Dove?',nameTitle:'Nome',organizedBy:'Da',planPreviewEmpty:'Il tuo piano apparirà qui...',searchPlacePh:'Cerca un luogo... (Invio)',myProfile:'Il mio profilo',editBtn:'Modifica',nameLbl:'Nome *',yourNamePh2:'Il tuo nome',usernameLbl:'Nome utente *',usernameHint:'Così gli altri possono trovarti.',myPlansTitle:'I miei piani',lightMode:'Modalità chiara',darkMode:'Modalità scura',icsDesc:'Piano creato con queda.',icsCode:'Codice',summaryMsg:(y,t,l,no,n)=>`${y} di ${t} possono il ${l}${no>0?' · '+no+' no':''}.`,
