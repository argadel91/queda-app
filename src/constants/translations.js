...
whenTitle:'Quando?',whereTitle:'Onde?',nameTitle:'Nome',organizedBy:'Por',planPreviewEmpty:'O seu plano aparecerá aqui...',searchPlacePh:'Procurar um local... (Enter)',myProfile:'O meu perfil',editBtn:'Editar',nameLbl:'Nome *',yourNamePh2:'O seu nome',usernameLbl:'Nome de utilizador *',usernameHint:'Para que outros o possam encontrar.',myPlansTitle:'Meus planos',lightMode:'Modo claro',darkMode:'Modo escuro',
icsDesc:'Plano criado com queda.',icsCode:'Código',summaryMsg:(y,t,l,m,n)=>`${y} de ${t} podem em ${l}${m>0?' · '+m+' talvez':''}${n>0?' · '+n+' por responder':''}.`,
...
landingSignIn:'Accedi',landingHero1:'Più piani,',landingHero2:'meno caos.',landingSub2:'Dì addio alle chat infinite.',landingCTA2:'Inizia',landingFooter:'Piani di gruppo, zero caos.',whenTitle:'Quando?',whereTitle:'Dove?',nameTitle:'Nome',organizedBy:'Da',planPreviewEmpty:'Il tuo piano apparirà qui...',searchPlacePh:'Cerca un luogo... (Invio)',myProfile:'Il mio profilo',editBtn:'Modifica',nameLbl:'Nome *',yourNamePh2:'Il tuo nome',usernameLbl:'Nome utente *',usernameHint:'Così gli altri possono trovarti.',myPlansTitle:'I miei piani',lightMode:'Modalità chiara',darkMode:'Modalità scura',icsDesc:'Piano creato con queda.',icsCode:'Codice',summaryMsg:(y,t,l,m,n)=>`${y} di ${t} possono il ${l}${m>0?' · '+m+' forse':''}${n>0?' · '+n+' in attesa':''}.`,
