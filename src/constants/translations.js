...
const T ={
  ...
  en:{
    ...
    comments:'Comments',
    tabs:{plan:'📍 Plan',vote:'🗳️ Votes',summary:'📊 Summary',more:'💡 More'},voteWhen:'When?',voteWhere:'Where?',stopLbl:'Stop',codeLbl:'Plan code',transportLbl:'Transport',addressLbl:'Address',notesLbl:'Notes',delConfirm2:'Delete this stop?',noMinCap:'No min capacity',noMaxCap:'No max capacity',minCapLbl:'Min capacity',maxCapLbl:'Max capacity',minBeforeLbl:'Minutes before',toleranceLbl:'Tolerance (max late)',onTimeQ:'Will you be on time?',howLateQ:'How late?',maxLateLbl:'Max late',onTimeLbl:'On time',meetYes:"I'll be there!",meetNo:'Going directly',respSaved:'✓ Saved — tap to update',availStartTime:'What time could you start?',
