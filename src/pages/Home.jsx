...
export default function Home({onCreate,onJoin,onProfile,c,lang}){
  ...
  return(<div style={{padding:'52px 24px 40px',maxWidth:'420px',margin:'0 auto'}}>
    ...
    <Btn onClick={onProfile} v="secondary" full style={{padding:'12px',fontSize:'14px',marginBottom:'16px'}} c={c}>{t.myPlans}</Btn>
